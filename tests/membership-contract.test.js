...
console.log('Shared Account Shell v4 with Google/GitHub/X OAuth, account-backed card inventory, personal cloud history, stable PWA cache lifecycle, trusted entitlement boundary, privacy, rankings, and RLS checks validated');
